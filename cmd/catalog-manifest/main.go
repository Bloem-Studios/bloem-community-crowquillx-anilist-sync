...
func encodeCatalogManifest(path, version string) ([]byte, error) {
	...
	// Silo's repository index uses encoding/json around generated protobuf
	// structs. Marshaling the loaded message here emits numeric enums while
	// preserving protobuf field names and struct values in that exact format.
